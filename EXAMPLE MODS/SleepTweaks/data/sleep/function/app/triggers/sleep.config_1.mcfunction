...
[\
  ...
  {\
    ...
    "clickEvent":{\
      "action":"run_command",\
      "value":"/function sleep:app/config/percentage/increase"\
    }\
  },\
  " ",\
  {\
  ...
  {\
    ...
    "clickEvent":{\
      "action":"run_command",\
      "value":"/function sleep:app/config/percentage/decrease"\
    }\
  },\
  {\
    "color":"gray",\
  ...
  {\
    "score":{\
      "objective":"sleep.players_online",\
      "name":"&playerNum_percentage_to_sleep"\
    }\
  },\
  {\
    "color":"gray",\
    "text":" player(s) have to sleep"\
  },\
  "\n\n",\
  {\
